			...
			<!-- container --> 
				<!-- row --> 
					<div class="card">
						...
						<td>
						<a href="http://localhost:8080/Pentalver/modifierCommandeClient?id_c=${ commande.id_commande}"<span class="label label-success label-rounded">Modifier</span>></a>
						<a href="http://localhost:8080/Pentalver/deleteCommandeClient?id_c=${ commande.id_commande}"<span class="label label-danger label-rounded">Supprimer</span>></a>
						 </td>
